Shader "HDRP/LitCustomIntersection"
{
    Properties
    {
        ...
        [HideInInspector] _CullModeGDRP("_CullModeGDRP", Vector) = (2, 0, 0, 3) // x:_CullMode y:_DoubleSidedEnable, w:_SupportDecals, _ReceiveSSR
    ...
    SubShader
    {
        ...
        {
            Name "GBufferSplat"
            Tags{ "LightMode" = "GBufferSplat" } // This will be only for opaque object based on the RenderQueue index
            ...
            #define SHADERPASS SHADERPASS_GBUFFER_SPLAT
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/ShaderLibrary/ShaderVariablesGDRP.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitProperties.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitPropertiesGDRP.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassGBufferSplatProperties.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassGBufferSplat.hlsl"
        ...
        Pass
        {
            ...
            #define SHADERPASS SHADERPASS_VBUFFER_ALPHA_CLIP
            #undef UNITY_GPU_DRIVEN_PIPELINE
            #define UNITY_GPU_DRIVEN_PIPELINE

            #define _ScreenSize _DrawModeScreenSize
        ...
        pass
        {
           ...
           HLSLPROGRAM
            ...
            //#undef HAVE_VERTEX_MODIFICATION
            #define SHADERPASS SHADERPASS_ALPHA_MESH_SELECTION
            #undef UNITY_GPU_DRIVEN_PIPELINE
            #define UNITY_GPU_DRIVEN_PIPELINE
            float4 _DrawModeScreenSize;
            #define _ScreenSize _DrawModeScreenSize
        ...
        // #endif
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
            #include "GPUVisibleBucketCommon.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassAlphaMeshSelection.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "MRaytracingIntersection.hlsl"
